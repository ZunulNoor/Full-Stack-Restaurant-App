        ...
        <>
            <div className="card">
                ...
                <div className="card__avatar">
                    <img src="https://static-00.iconduck.com/assets.00/user-icon-2048x2048-ihoxz4vq.png" style={{ width: '80%' }} alt="" />
                </div>
                <div className="card__title">{currentUser.username}</div>
                <div className="card__subtitle">{currentUser.email}</div>
                <div className="card__subtitle">{currentUser.contact}</div>
                <div className="card__subtitle">{currentUser.joining}</div>
